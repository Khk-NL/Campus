...
2. 将 `experiments/pocketbase/pb_migrations/` 里的 4 个基础迁移及 `deploy/pocketbase/pb_migrations/1790210000_public_accounts.js` 一起放到服务器的 `/opt/campus/pocketbase/pb_migrations/`。这是**全新生产库**的迁移集合；不要把生产注册策略迁入原有本机试点库。
